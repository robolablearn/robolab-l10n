...
export default {
  "en": {
    ...
    "gui.telemetryOptIn.optInText": "Share my usage data with the Robolab Team",
    "gui.telemetryOptIn.optInTooltip": "Enable telemetry",
    "gui.telemetryOptIn.optOutText": "Do not share my usage data with the Robolab Team",
    ...
    "gui.updateModel.alreadyLatestTips": "Robolab is already the latest version.",
  ...
  "ru": {
    ...
    "gui.updateModel.alreadyLatestTips": "Установлена самая последняя версия Robolab",
  ...
  "zh-cn": {
    ...
    "gui.telemetryOptIn.optInText": "与 Robolab 团队分享我的使用数据",
    "gui.telemetryOptIn.optInTooltip": "发送统计信息",
    "gui.telemetryOptIn.optOutText": "不要与 Robolab 团队分享我的使用数据",
    ...
    "gui.updateModel.alreadyLatestTips": "Robolab 已经是最新的版本了。",
  ...
  "zh-tw": {
    ...
    "gui.updateModel.alreadyLatestTips": "Robolab 已經是最新的版本了。",
